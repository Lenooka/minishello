NAME = minishell
CC = cc
SRCS = heredoc_utils.c cute_utils.c strcompr.c replace_var.c replace_var2.c str_arr_utils.c quotes_utils.c  libft_bonus.c echo.c built_ex.c export_empty.c export.c comand_list_init.c envlist_init.c exit_status.c minishell_var_init.c execution_start.c syntax_checks_utils.c syntax_checks.c syntex_error.c other_syntax_checks.c utils.c exstart_utils.c parser_start.c split_token_utils.c split_token.c  heredoc.c signals.c frees.c builtin_extras.c redirections.c inoutredir.c pwd.c exe_cutie.c cd.c exit.c  env.c unset.c list_utilslibftbonus.c more_free.c isbuilt.c char_checks.c minishell.c 
